    ...
    public partial class frmReporte : Form
    {
        ...
        private void frmReporte_Load(object sender, EventArgs e)
        {
            ...
            foreach (Proveedor pr in ProveedorLogica.Instancia.Listar()) {
                cboproveedor.Items.Add(new ComboBoxItem() { Value = pr.IdProveedor, Text = pr.Nombre });
            }
        ...
        {
            dtproducto = ProductoLogica.Instancia.Reporte(txtfechainicioprod.Value.ToString("dd/MM/yyyy"), txtfechafinprod.Value.ToString("dd/MM/yyyy"));
            if (dtproducto != null)
            {
